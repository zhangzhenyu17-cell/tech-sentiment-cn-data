...
def _fact(entity, period, fact_type, value, available, doc):
...
def _period(entity, period, available, doc, revenue, profit, cash, margin):
    return [
        _fact(entity, period, "OPERATING_REVENUE", revenue, available, doc),
        _fact(entity, period, "NET_PROFIT_PARENT", profit, available, doc),
        _fact(entity, period, "OPERATING_CASH_FLOW_NET", cash, available, doc),
        _fact(entity, period, "NET_PROFIT_MARGIN", margin, available, doc),
    ]
