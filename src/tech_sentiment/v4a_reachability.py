...
REQUIREMENTS: tuple[ReachabilityRequirement, ...] = (
    ...
    ReachabilityRequirement(
        ...
        contract_paths=("reference/v4a_fundamental_pit_state_contract_v1.json",),
        source_identities=(
    ...
    ReachabilityRequirement(
        ...
        historical_reconstruction_path="exact issuer forecast/warning/restatement documents -> explicit standardized guidance direction; UNKNOWN never means NOT_DOWN",
        output_paths=(
        ...
        coverage_metadata="per-entity official source-window and explicit direction extraction completeness",
    ...
    ReachabilityRequirement(
        ...
        coverage_metadata="per-entity eligible/usable valuation rows with denominator identity",
